"""Utility functions for sampling using keyword (IFG) or directly """
...
def generate_from_model(
    model: vllm.LLM | transformers.PreTrainedModel,
    prompts: list[str],
    sampling_params: (vllm.SamplingParams | transformers.GenerationConfig),
) -> list[str]:
